...
namespace BeautyContestTW.WindowsService.Entity
{
    public class RepositoryHelper
    {
        ...
        public static DataSet ExecuteDatasetBySqlCommand(string connString, string sqlcommand)
        {
            return SqlHelper.ExecuteDataset(connString, CommandType.Text, sqlcommand);
        }
    }
}
