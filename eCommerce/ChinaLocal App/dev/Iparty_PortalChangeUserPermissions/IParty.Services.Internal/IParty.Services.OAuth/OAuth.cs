...
namespace IParty.Services.OAuth
{
    public class OAuth : IOAuth
    {
        ...
        const string MISSING_AUTH = "Bearer realm=\"MobileApi\",error=\"invalid_token\", error_description=\"The access token is missing\"";
        const string BAD_TOKEN = "Bearer realm=\"MobileApi\", error=\"invalid_token\", error_description=\"The access token is invalid\"";
        const string EXPIRED_TOKEN = "Bearer realm=\"MobileApi\", error=\"invalid_token\", error_description=\"The access token is expired\"";
