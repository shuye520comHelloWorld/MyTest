            ...
            pageConf: {
                ...
                newTr: function (data) {
                    return '<tr>' +
                            ...
                            '<td class="NormalTicketQuantity" oninput="layer.handleInput(event)" data-role="NormalTicketQuantity"  >' + (data.NormalTicketQuantity) + '</td>' +
                            '<td class="VIPTicketQuantity" oninput="layer.handleInput(event)" data-role="VIPTicketQuantity"  >' + (data.VIPTicketQuantity) + '</td>' +
