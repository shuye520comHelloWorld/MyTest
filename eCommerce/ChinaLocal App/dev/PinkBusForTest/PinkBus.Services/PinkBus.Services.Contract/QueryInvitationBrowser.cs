...
namespace PinkBus.Services.Contract
{
    ...
    [Api("get the ticket detail infomation when customer open the invitation link in H5 page with browser")]
    [Route("/customer/invitation/query/{TicketKey}", "GET, OPTIONS")]
    public class QueryInvitationBrowser : QueryRequestDto, IReturn<QueryInvitationResponse>
    {
