...
using PinkBus.Services.Internal.Validator;

using PinkBus.Services.Internal.Infrastructure;
...
namespace PinkBus.Services.Internal.Host
{
    public class PinkBusInternalHost : AppHostBase
    {
        public PinkBusInternalHost()
            : base("PinkBus internal Service", typeof(PinkBus.Services.Internal.API.WechatService).Assembly) { }
        ...
        {
            container.RegisterAutoWiredAs<WechatServiceRepository, IWechatServiceRepository>();
