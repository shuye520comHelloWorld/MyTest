...
namespace PinkBus.Services.H5.Host
{
    public class PinkBusH5Host : AppHostBase
    {
        public PinkBusH5Host()
            : base("PinkBus Intouch Service", typeof(PinkBus.Services.H5.API.InvitationService).Assembly) { }
